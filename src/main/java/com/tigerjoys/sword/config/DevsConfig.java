...
public class DevsConfig {
	...
	static {
		try {
			prop.load(DevsConfig.class.getClassLoader().getResourceAsStream("devs.configuration.properties"));
		} catch (Exception e) {
	...
	public static int INDEX_METHOD_NAME = Integer.parseInt(prop.getProperty("INDEX_METHOD_NAME"));
	public static int INDEX_METHOD_RESOURCES = Integer.parseInt(prop.getProperty("INDEX_METHOD_RESOURCES"));
	// index fields
	...
	public static String HANDLER_NAME_LOG_JSON_IN = prop.getProperty("HANDLER_NAME_LOG_JSON_IN");
	public static String HANDLER_RESOURCES_LOG_JSON_IN = prop.getProperty("HANDLER_RESOURCES_LOG_JSON_IN");
	...
	public static String SEPERATOR_TAB = prop.getProperty("SEPERATOR_TAB");
	// paths
	...
	public static String FIELDS_DEVS_AARAY = prop.getProperty("FIELDS_DEVS_AARAY");
	public static String FIELDS_DEVS_AARAY_PERMISSION = prop.getProperty("FIELDS_DEVS_AARAY_PERMISSION");
	public static String FIELDS_DEVS_AARAY_NAME = prop.getProperty("FIELDS_DEVS_AARAY_NAME");
	public static String FIELDS_DEVS_AARAY_GROUP = prop.getProperty("FIELDS_DEVS_AARAY_GROUP");
	public static String FIELDS_DEVS_AARAY_OWNER = prop.getProperty("FIELDS_DEVS_AARAY_OWNER");
	public static String FIELDS_DEVS_AARAY_TIME = prop.getProperty("FIELDS_DEVS_AARAY_TIME");
	...
	public static String FIELDS_MODEL = prop.getProperty("FIELDS_MODEL");
	public static String FIELDS_BRAND = prop.getProperty("FIELDS_BRAND");
	public static String FIELDS_APPID = prop.getProperty("FIELDS_APPID");
	public static String FIELDS_SUCESS = prop.getProperty("FIELDS_SUCESS");
	// regular expression
	public static String REGEX_FIND_DATETIME = prop.getProperty("REGEX_FIND_DATETIME");
	public static String REGEX_FIND_RECORD_TIME = prop.getProperty("REGEX_FIND_RECORD_TIME");
	public static String REGEX_FORMAT_DATETIME = prop.getProperty("REGEX_FORMAT_DATETIME");
	...
	public static String TYPE_JSON_IN = prop.getProperty("TYPE_JSON_IN");
